...
export default function AssessmentLandingPage() {
  ...
  const versions: { key: Version; icon: string; title: string; desc: string; time: string; questions: string; features: string[]; tag: string; tagColor: string }[] = [
    {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-500 mt-3">无需注册，完全免费 · 数据保存在你的浏览器本地</p>
      </div>
    </div>
  );
}
